...
class MiMoTokenPlanTtsEngine : AbstractTtsEngine() {
    ...
    override fun synthesize(
        ...
        val textChunks = TextChunker.splitTextIntoChunks(finalText, MAX_TEXT_LENGTH)
        ...
        engineScope.launch {
            if (mimoConfig.preGenerateCount > 0) {
    ...
    private fun buildHttpRequest(
        ...
        logDebug("HTTP Request Headers (masked): ${request.headers.toMaskedSensitive()}")

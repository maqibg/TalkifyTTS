...
*文档最后更新时间: 2026年07月17日*
*对应应用版本: 1.0.24*

> **改版说明**：本次更新新增了供应商自定义 API 地址和模型 ID 的配置能力。用户可在配置界面为每个供应商设置自定义的 API 端点和模型标识，未配置时自动使用供应商默认值。供应商展示界面会根据用户自定义的模型 ID 自适应更新"模型名称"。详见 [3.2.2 自定义 API 地址与模型 ID](#自定义-api-地址与模型-id) 章节。
